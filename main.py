...
image_input = ct.ImageType(shape=(1, 256, 256, 1), scale=1/255, bias=0, color_layout='G')
...
exImage = Image.open('274234352_368217161786364_4653297888454117985_n.jpg').resize((256, 256))
